...
def _dcu_record(dtr_id, pss_id, n_meters):
    return {
        ...
        "dcs_id":          "DCS_BALAJU_01",   # Data Collection System at substation
    }
...
def build_infrastructure(seed=42):
    ...
    for feeder in FEEDERS:
        ...
        for group in lv_groups:
            ...
            dcu = _dcu_record(dtr_id, pss["pss_id"], len(group))
            all_dcus.append(dcu)
        ...
        for cons in mv_consumers:
            ...
            dcu = _dcu_record(dtr_id, pss["pss_id"], 1)
            all_dcus.append(dcu)
